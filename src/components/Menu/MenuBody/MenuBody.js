...
export default function MenuBody({ phase, handleSetPhase, selectedWork, handleSetWork }) {
    if (phase === "intro") {
        return (
            <div className="intro">
                    ...
                    <div className="intro__shadow">
                        ...
                        >
                            <div className="intro__ribbon">
                                <h3 className="intro__button-text">Selected Work</h3>
                            </div>
                        </button>
                    </div>
                    <div className="intro__shadow">
                        ...
                        >
                            <div className="intro__ribbon">
                                <h3 className="intro__button-text">Contact Me</h3>
                            </div>
                        </button>
                    </div>
                </div>
        ...
        return (
            <div className="work-menu">
                ...
                >
                    <div
                        className={`work-menu__ribbon ${
                            selectedWork === "nerf" ? " work-menu__ribbon--selected" : ""
                        } work-menu__ribbon--nerf`}
                    >
                        <h3
                            className={`work-menu__label ${
                                selectedWork === "nerf" ? " work-menu__label--selected" : ""
                            } work-menu__label--nerf`}
                        >
                            Nerf Herder
                        </h3>
                        <h4 className="work-menu__description work-menu__description--nerf">
                ...
                >
                    <div
                        className={`work-menu__ribbon ${
                            selectedWork === "sandbox" ? " work-menu__ribbon--selected" : ""
                        } work-menu__ribbon--sandbox`}
                    >
                        <h3
                            className={`work-menu__label ${
                                selectedWork === "sandbox" ? " work-menu__label--selected" : ""
                            } work-menu__label--sandbox`}
                        >
                            Sandbox
                        </h3>
                        <h4 className="work-menu__description work-menu__description--nerf">
                ...
                >
                    <div
                        className={`work-menu__ribbon ${
                            selectedWork === "brainflix" ? " work-menu__ribbon--selected" : ""
                        } work-menu__ribbon--brainflix`}
                    >
                        <h3
                            className={`work-menu__label ${
                                selectedWork === "brainflix" ? " work-menu__label--selected" : ""
                            } work-menu__label--brainflix`}
                        >
                            BrainFlix
                        </h3>
                        <h4 className="work-menu__description work-menu__description--nerf">
                            React Video App Prototype
                        </h4>
                    </div>
                </button>
            </div>
        ...
        return (
            <div className="contact">
                <a href="blank" className="contact__link contact__link--linkedin">
                    <div className="contact__ribbon contact__ribbon--linkedin">
                        <svg className="contact__icon contact__icon--linkedin" viewBox="0 0 24 24">
                ...
                <a href="blank" className="contact__link contact__link--github">
                    <div className="contact__ribbon contact__ribbon--github">
                        <svg className="contact__icon contact__icon--github" viewBox="0 0 24 24">
                ...
                <a href="blank" className="contact__link contact__link--email">
                    <div className="contact__ribbon contact__ribbon--email">
                        <svg className="contact__icon contact__icon--email" viewBox="0 0 24 24">
